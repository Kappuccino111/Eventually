...
//     //                 <tr>
//     //                     <td>${item.year}</td>
//     //                     <td>${item.wind_energy_10m.toFixed(2)}</td>
//     //                     <td>${item.wind_energy_50m.toFixed(2)}</td>
//     //                     <td>${solar.ghi.toFixed(2)}</td>
//     //                     <td>${solar.dni.toFixed(2)}</td>
//     //                 </tr>
//     //             `;
//     //             });
...
//     //                 .openOn(map);
//     //         })
//     //         .catch(error => console.error('Error fetching wind/solar data:', error));
//     // }
//     function onPointClick(lat, lon) {
//         console.log(`Testing popup for lat: ${lat}, lon: ${lon}`);

//         L.popup()
//             .setLatLng([lat, lon])
//             .setContent(`<p>Test Popup for (${lat}, ${lon})</p>`)
//             .openOn(map);
//     }
//     // Attach click handler to dynamic points
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    //     // alert(`Point clicked at lat: ${lat}, lon: ${lon}`);
    // }

    // function onPointClick(lat, lon) {
    //     console.log(`Fetching wind-solar data for lat: ${lat}, lon: ${lon}`);

    //     // Create a popup with a loading message
